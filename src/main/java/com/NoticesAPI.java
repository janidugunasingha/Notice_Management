...
public class NoticesAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = noticeObj.insertNotice(request.getParameter("adminName"), 
				 						   request.getParameter("adminID"), 
				 						   request.getParameter("adminHeader"), 
				 						   request.getParameter("adminContent")); 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 String output = noticeObj.updateNotice(paras.get("hidNoticeIDSave").toString(), 
				 							...
				 							paras.get("adminHeader").toString(), 
				 							paras.get("adminContent").toString()); 
		response.getWriter().write(output); 
	}
